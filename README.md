...
- **注：项目已交接。现在[代码已用Java重写](https://github.com/AlbumenJ/switch-monitor)，[前端也移植到了别的框架](https://github.com/AlbumenJ/switch-monitor-web)。同时有了[微信小程序版本的前端](https://github.com/AlbumenJ/switch-monitor-mpvue)。该仓库应该不会有更新了。**  
- 2019年1月31日记：学校新建了两栋楼，现在要监控的交换机数量为810台。  
